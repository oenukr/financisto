...
public class MyDatabaseTest extends AbstractDbTest {
    ...
    @Test
    public void payee_sort_order() { // currently we ignore sort_order column
        findOrInsertPayee("Payee1");
        findOrInsertPayee("Payee2");
        ...
        Payee p3 = findOrInsertPayee("Payee3");
        Payee p4 = findOrInsertPayee("Payee4");
    ...
    @Test
    public void should_save_payee_once() {
        // given
        String payee = "Payee1";
        // when
        Payee p1 = findOrInsertPayee(payee);
    ...
    @Test
    public void should_set_split_status_when_inserting_new_transaction() {
        // when
    ...
    @Test
    public void should_update_split_status_when_changing_status_of_the_parent_transaction() {
        // given
        Transaction t = TransactionBuilder.withDb(db).account(a1).amount(1000)
                .withSplit(categoriesMap.get("A1"), 100)
                .withSplit(categoriesMap.get("A2"), 900)
    ...
    @Test
    public void should_run_mass_operations() {
        // given
    ...
    private Payee findOrInsertPayee(String payee) {
        return db.findOrInsertEntityByTitle(Payee.class, payee);
    }
