...
public class DatabaseAdapterTest extends AbstractDbTest {
    ...
    @Test
    public void should_remember_last_used_transaction_for_the_payee() {
        //when
    ...
    @Test
    public void should_search_payee_with_or_without_first_letter_capitalized() {
        // given
    ...
    @Test
    public void should_detect_multiple_account_currencies() {
        // one account only
    ...
    @Test
    public void should_return_id_of_the_nearest_transaction_which_is_older_than_specified_date() {
        //given
    ...
    @Test
    public void should_delete_old_transactions() {
        //given
        a2 = AccountBuilder.createDefault(db);
    ...
    @Test
    public void should_find_latest_transaction_date_for_an_account() {
        //given
    ...
    @Test
    public void should_restore_system_entities() {
        //given
    ...
    @Test
    public void account_number_lookup() {
