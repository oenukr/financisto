    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        View view_amount_input = hasViews.internalFindViewById(R.id.amount_input);
        ...
        if (view_amount_input!= null) {
            view_amount_input.setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View view) {
                    AmountInput_.this.onClickUpDown();
                }
            }
            );
        }
