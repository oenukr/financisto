...
//        childColumns = ["currency_id"]
//    )
    @ColumnInfo(name = "currency_id") var currency: Long? = null,
    ...
    @ColumnInfo(name = "last_account_id") var lastAccountId: Long = 0,
    @ColumnInfo(name = "last_category_id") var lastCategoryId: Long = 0,
