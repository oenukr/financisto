...
public class GraphStyle {
    ...
    public static class Builder {
        ...
        public Builder(float screenDensity) {
        ...
        public GraphStyle build() {
            ...
            namePaint.setTextSize(spToPx(nameTextSize, screenDensity));
            ...
            amountPaint.setTextSize(spToPx(amountTextSize, screenDensity));
            ...
            return new GraphStyle(
                    spToPx(dy, screenDensity),
                    spToPx(textDy, screenDensity),
                    spToPx(indent, screenDensity),
                    spToPx(lineHeight, screenDensity),
                    nameHeight,
                    amountHeight,
                    namePaint,
                    amountPaint,
